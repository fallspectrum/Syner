...
7. Run the installation wizard by navigating to
...
8. Follow  any additional instructions in the installation wizard.
9. Configure  system/application/config/email.php to fit your email settings. By
